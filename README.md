...
## 使用技術
 ...
 ## インフラ
  ...
  - AWS(VPC、ACM、Route53、IAM、ALB、EC2、RDS、S3、CloudFront、ECS（fargate）)
 ## 開発環境
  - VScode
...
「時間を短縮し、目的に沿ったキャン場の選択ができる」ことをテーマに課題解決するため、制作することに至りました。<br />
...
ターゲットを初心者に絞り、キャンプに詳しくなくても、目的に沿ったオススメのキャンプ場を紹介します。<br />
また、サイトからのオススメだけではなく、ユーザーが投稿することもできるので、多角的に情報を共有できます。<br />
その結果、サイトとユーザーが、より質の高いキャンプ情報を提供できるサービスを目指しています。<br />
